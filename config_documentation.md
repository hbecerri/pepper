...
- `split_btag_year_corr`: Optional, boolean. If true, split btagging uncertainties into components correlated and uncorrelated across years (not this requires this splitting to exist in the SF csv). If not specified, default is `false`.
