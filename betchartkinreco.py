...
class nuSolutionSet(object):
    ...
    def __init__(self, b, mu, # Lorentz Vectors
        ...
        self.c = r.Math.VectorUtil.CosTheta(b,mu) #ROOT is here!
    ...
    def N(self):
        ...
        E = self.E_perp
	print(E)
	print(np.linalg.inv(E.T).dot(UnitCircle()).dot(np.linalg.inv(E)))
...
class doubleNeutrinoSolutions(object):
    ...
    def __init__(self, (b,b_), (mu,mu_), # Lorentz Vectors
        ...
        for B,M in zip((b,b_),(mu,mu_)): print(B,M)
...
if __name__ == '__main__':
  lep=lv(165.33320, 26.923591, 16.170616, -162.3227)
  antilep=lv(49.290821, -34.58441, -13.27824, -32.51431)
  b=lv(205.54469, 99.415420, -78.89404, -161.6102)
  antib=lv(362.82086, -49.87086, 91.930526, -347.3868)
  nu=lv(70.848953, 34.521587, -51.23474, -6.555319)
  antinu=lv(13.760989, 11.179965, -3.844941, 7.0419898)
  metx=nu.x()+antinu.x()
  mety=nu.y()+antinu.y()
  dns = doubleNeutrinoSolutions((antib, b), (lep, antilep), (metx, mety))
